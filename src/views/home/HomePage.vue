...
<template>
  ...
  <div id="relative w-screen h-full bg-white flex">
    ...
    <div class="w-full  flex flex-col justify-center items-center z-10">
      ...
      <div class="w-[70%] h-[60vh] flex flex-col justify-center items-center relative z-10">
        ...
        <div
          ...
          <span
            class="block w-[2vw] h-[2vw] bg-[url('../../assets/img/Home/arrow2.png')] bg-contain bg-no-repeat"></span>
    ...
    <div ref="toTopRef"
      class="fixed w-10 h-10 bg-white rounded-full bg-[url('@/assets/images/')] right-[10%] bottom-[5%] shadow-[2px_3px_5px_rgba(0,0,0,0.5)] flex justify-center items-center">
      <ArrowUp />
    </div>
  </div>
